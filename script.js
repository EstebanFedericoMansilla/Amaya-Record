document.addEventListener('DOMContentLoaded', () => {
    ...
    if (productionForm) {
        productionForm.addEventListener('submit', (e) => {
            ...
            const message = `Hola Facundo! 🎹%0A%0AHe completado el formulario de producción en la web:%0A%0A👤 *Artista:* ${nombre}%0A🎵 *Género:* ${genero}%0A📝 *Letra/Idea:* ${letra}%0A🔗 *Demo Link:* ${demo}%0A%0A🚀 ¡Espero tu respuesta para empezar a trabajar!`;
